...
CREATE  TABLE `live_game`(
  ...
  `a_id` tinyint(1) unsigned NOT NULL DEFAULT 0,//a队
  `b_id` tinyint(1) unsigned NOT NULL DEFAULT 0,//b队
  `a_score` int(10) unsigned NOT NULL DEFAULT 0,
  `b_score` int(10) unsigned NOT NULL DEFAULT 0,
  `narrator` VARCHAR(20) NOT NULL DEFAULT '',//解说员
  `image` VARCHAR(20) NOT NULL DEFAULT '',
...
CREATE  TABLE `live_outs`(
  ...
  `image` VARCHAR(20) NOT NULL DEFAULT '',
  `type` tinyint(1) unsigned NOT NULL DEFAULT 0,//赛事第几节
  `status` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `create_time` int(10) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT charset=utf8;
